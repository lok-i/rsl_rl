...
> [!NOTE]
> This checkout is a research fork for SONIC adaptation and vision-token extraction. See
> [`FORK.md`](FORK.md) for its exact surface and differences from upstream.
